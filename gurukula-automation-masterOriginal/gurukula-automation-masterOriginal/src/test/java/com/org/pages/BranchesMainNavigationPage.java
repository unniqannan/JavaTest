...
public class BranchesMainNavigationPage extends Services {
	static Logger logger = Logger.getLogger(BranchesMainNavigationPage.class.getName());
	...
	public BranchesMainNavigationPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
