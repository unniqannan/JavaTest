...
public class StaffMainNavigationPage extends Services {

    static Logger logger = Logger.getLogger(StaffMainNavigationPage.class.getName());
    ...
    public StaffMainNavigationPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
