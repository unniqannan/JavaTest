...
public class LoginPage extends Services {
     ...
     */
    public void loginAndAssertSuccessfulMessage(String username, String password) {
     ...
     * @param password: enter password
     */
    public void assertLoginValidationMsg(String username, String password) {
        loginAction(username, password);
    ...
    private void loginAction(String username, String password) {
        assertAndTypeById(idUsernameTextField, username);
        assertAndTypeById(idPasswordTextField, password);
