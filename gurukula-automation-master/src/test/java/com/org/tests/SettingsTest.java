...
public class SettingsTest extends StartApplication {
	...
	public Object[][] validations() {
		return new Object[][] {
			// @formatter:off
            {SettingsPage.FIRST_NAME, AppValidationMessages.FIRST_NAME_REQUIRED, " "},
            {SettingsPage.FIRST_NAME, AppValidationMessages.FIRST_NAME_MINIMUM, ""},
            {SettingsPage.FIRST_NAME, AppValidationMessages.FIRST_NAME_MAXIMUM,
                "this text is to test the maximum limit of the First Name text field"},

            {SettingsPage.LAST_NAME, AppValidationMessages.LAST_NAME_REQUIRED, " "},
            {SettingsPage.LAST_NAME, AppValidationMessages.LAST_NAME_MINIMUM, ""},
            {SettingsPage.LAST_NAME, AppValidationMessages.LAST_NAME_MAXIMUM,
                "this text is to test the maximum limit of the Last Name text field"},

            {SettingsPage.EMAIL, AppValidationMessages.EMAIL_REQUIRED, " "},
            {SettingsPage.EMAIL, AppValidationMessages.EMAIL_MINIMUM, "a@b"},
            {SettingsPage.EMAIL, AppValidationMessages.EMAIL_INVALID, "abcdef"},
            {SettingsPage.EMAIL, AppValidationMessages.EMAIL_MAXIMUM,
