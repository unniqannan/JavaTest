...
Feature: Search Staff 
	...
	Scenario: Creating multiple Staffes to search with the Staff Name       
    ...
    Then Staff details should be shown in the Staff list for "oneStaffSELENIUM"
  	...
  	Scenario: Staff details list should not be shown when user tries to search with partial Staff name   
    Given Search_Staff_Feature_User launches the application and navigates to Account Menu > Staffes with default admin login
  ...
  Scenario: Staff details should be shown when user search with small case or upper cases as it is not a case sensitive   
    Given Search_Staff_Feature_User launches the application and navigates to Account Menu > Staffes with default admin login
   ...
   Scenario: Staff details should NOT be shown when user search with Staff NAMES BY GIVING SPACES BETWEEN WORDS 
    Given Search_Staff_Feature_User launches the application and navigates to Account Menu > Staffes with default admin login
	...
	Scenario: Staff details should NOT be shown when user search with criteria of invalid Staff code, invalid Staff name, partial Staff name, partial code 
    Given Search_Staff_Feature_User launches the application and navigates to Account Menu > Staffes with default admin login
    ...
    |52432424"£$£"$fsaf|
     ...
     Scenario: Staff details should be shown when search is clicked with blank criteria    
    Given Search_Staff_Feature_User launches the application and navigates to Account Menu > Staffes with default admin login
