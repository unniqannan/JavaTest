...
Feature: Title of your feature
  I want to use this template for my feature file
    ...
    And User logs in and navigates to Staff page by clicking Account Menu > Staff    
    And  User able to click Create a new Staff link
    And User provides the details "CancelStaffName" and "oneBRANCHSELENIUM" in the Create new Staff popup page and clicks Cancel button
    Then User cannot see the Staff "CancelStaffName" and "oneBRANCHSELENIUM" in the Staffs page as it is cancelled
    
    Scenario: Staff page > View -User would be able to see the Branch details by clicking view link   
     Given Staff Feature_User launches the application
    And User logs in and navigates to Staff page by clicking Account Menu > Staff  
    ...
    Scenario: Create Staff Functionality> Staff created Functionality -User would be able to create a new staff without the branch selection   
  	Given Staff Feature_User launches the application
    And User logs in and navigates to Staff page by clicking Account Menu > Staff   
    Then create four different Staffs  of <Name> and <Branch>  
    |Name	|	|
