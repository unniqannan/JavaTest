...
Feature: Search Branch 
		 ...
		 Scenario: Creating multiple Branches to search with the Branch Name       
...
Scenario: Branch details list should be shown when user tries to search with partial branch name   
    Given Search_Branch_Feature_User launches the application and navigates to Account Menu > Branches with default admin login
  ...
  Scenario: Branch details should be shown when user search with small case or upper cases as it is not a case sensitive   
    Given Search_Branch_Feature_User launches the application and navigates to Account Menu > Branches with default admin login
    ...
    |ONEbranchSELEnium|
     ...
     Scenario: Branch details should be shown when user search with BRANCH CODE      Given Search_Branch_Feature_User launches the application
    Given Search_Branch_Feature_User launches the application and navigates to Account Menu > Branches with default admin login
    When user search for the branch using branch name with "77" 
    Then branch details should be shown for code "77" 

Scenario: Branch details should NOT be shown when user search with BRANCH NAMES BY GIVING SPACES BETWEEN WORDS  
    Given Search_Branch_Feature_User launches the application and navigates to Account Menu > Branches with default admin login
...
Scenario: Branch details should NOT be shown when user search with criteria of invalid branch code, invalid branch name, partial branch name, partial code 
    Given Search_Branch_Feature_User launches the application and navigates to Account Menu > Branches with default admin login
   ...
   Scenario: Branch details should be shown when search is clicked with blank criteria    
    Given Search_Branch_Feature_User launches the application and navigates to Account Menu > Branches with default admin login
